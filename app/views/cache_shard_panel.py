...
class CacheShardPanel(ft.Container):
    ...
    last_overview_data: dict[str, Any]

    def __init__(self, page: ft.Page, state: CacheShardState, last_overview_data: dict[str, Any]) -> None:
        """初始化 CacheShardPanel。
    ...
    def _iter_type_states(self, data: dict[str, Any]) -> list[tuple[str, dict[str, Any]]]:
        """迭代所有快取類型與其狀態"""
    ...
    # ==================== SRC/DST 面板 ====================
    def _load_shard_entry(self, cache_type: str, filename: str, key: str) -> dict[str, Any] | None:
        """從分片檔案載入單一 entry"""
        import json
